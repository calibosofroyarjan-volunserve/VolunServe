    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        const nextCenters = snapshot.docs
          .map((item) => ({
            id: item.id,
            ...(item.data() as Omit<EvacuationCenter, "id">),
          }))
          .sort((a, b) =>
    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.hero}>
        ...
        <Text style={styles.subtitle}>
          View official evacuation-center availability without
          exposing private resident or responder locations.
        </Text>
      </View>
      ...
      <View style={styles.notice}>
        ...
        <Text style={styles.noticeText}>
          Live disaster-case coordinates are available only to
          authorized users.
        </Text>
      </View>
            ...
            >
              ...
              {available !== null && (
                <Text style={styles.capacity}>
                  {available} of {capacity} spaces currently
                  available
                </Text>
              )}
            </View>
