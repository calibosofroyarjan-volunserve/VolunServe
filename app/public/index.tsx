      ...
      <View style={styles.root}>
        ...
        >
          <View style={styles.heroSection}>
            <Text style={styles.welcomePlain}>Welcome to</Text>

            <Animated.Text
              style={[styles.welcomeBrand, { color: animatedBrandColor }]}
            >
              VolunServe SJDM
            </Animated.Text>
          ...
          >
            <ModuleCard
              ...
              onPress={() => router.push("/public/donation")}
            />
            ...
            <ModuleCard
              ...
              onPress={() => router.push("/public/volunteer")}
            />
            ...
            <ModuleCard
              ...
              onPress={() => router.push("/public/resident")}
            />
            ...
            <ModuleCard
              ...
              onPress={() => router.push("/public/disaster-response")}
            />
            ...
            <ModuleCard
              ...
              onPress={() => router.push("/public/map-tracking")}
            />
          </Animated.View>
        </Animated.ScrollView>
      </View>
...
const styles = StyleSheet.create({
  ...
  welcomeBrand: { fontSize: 30, fontWeight: "900", textAlign: "center" },
  subText: {
    fontSize: 16,
    textAlign: "center",
    color: "#4b5563",
